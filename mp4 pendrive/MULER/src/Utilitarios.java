...
public class Utilitarios
{
            ...
            //confirmação de senha, e data do cadastro
    {
        ...
        {
            File arquivo;
            String sNomeDiretorio = "\\media\\MP3\\MULER\\";
            
            arquivo = new File( sNomeDiretorio + sUsuario +".txt");
    ...
    public static void gravaPerguntas(short shNumeroDaQuestão, short numeroCodigoPergunta, String sUsuario, String sPergunta)//grava Perguntas
    {
        ...
        try
        {
            ...
            BufferedWriter out = new BufferedWriter(new FileWriter(formatador.format(numeroCodigoPergunta) + sUsuario+".txt", true));
    ...
    public static void criarDiretorio(String sDiretorio)// cria diretorio
    {
    ...
    public static void carregaParametrosDataHora(String sUsuario) // mostra ultimo acesso, void
    {
        ...
        {
            System.out.println("Erro ao carregar a data" + eeerro);
            //return false;
        }
        /*String parametros = "Parametros carregados: \n \n" +
                "Usuario..........:" + sUsuario + "\n" +
        ...
        while (codigoPergunta < 100)
            {
                try
                {
                    ...
                    Properties config = new Properties();
                    String arquivo = formatador.format(codigoPergunta)+sUsuario+".txt";
                    config.load(new FileInputStream(arquivo));            
    ...
    public static void gravaEntrevistados(String sMatricula, String sNome, String sTelefone, String sEmail)//grava entrevistados
    {
        try
        {
            BufferedWriter out = new BufferedWriter(new FileWriter( sMatricula + ".txt", true));
        ...
        {
            System.out.println("Erro ao gravar entrevistados");
        }
    }
    ...
    public static boolean carregaParametrosDadosEntrevistado(String sMatricula, String sTelefone, String sEmail) // confirma dados do entrevistado
    {
        ...
        {
            System.out.println("");//quando não acha matricula passada para realização do cadastro
            return false;
        }
    }
    ...
    public static boolean carregaParametrosNumeroDeGrupoPerguntasExiste(String sMatricula, String sCodigo, String sUsuario) // existe grupo de pergunta
    {
        ...
        try
        {
            ...
            Properties config = new Properties();
            String arquivo =  formatador.format(shCodigo)+sUsuario+".txt";
            ...
            while(input.ready())
            {
                ...
                sPerguntaCadastrada = sPerguntaCadastrada.substring(16, sPerguntaCadastrada.length());
                Utilitarios.mostraNaTela(sPerguntaCadastrada);
    ...
    public static void gravaRespostasEntrevistados(String sMatricula, String sCodigoConjuntoPerguntas, String sPergunta, String sResposta)//grava respostas do entrevistado
    {
        try
        {
            BufferedWriter out = new BufferedWriter(new FileWriter( sMatricula + "+" + sCodigoConjuntoPerguntas + ".txt", true));
        ...
        {
            System.out.println("Erro ao gravar respostas entrevistados");
        }
    }
    ...
    public static void carregaParametrosTodosDadosEntrevistado(String sMatricula) // mostra dados do entrevistado
    {
        ...
        try 
        {
            ...
            while(input.ready())
            {                            
                sDadosGravados = input.readLine();//pega até a ultima linha do cadastro do entrevistado
    ...
    public static void carregaParametrosTodasRespostasEntrevistado(String sMatricula) // mostra dados do entrevistado
    {
        ...
        {            
            ...
            {
                Properties config = new Properties();
                String arquivo =  sMatricula + "+"+ String.valueOf(codigoPergunta) +".txt";
        ...
        {
                System.out.println("A matricula não esta cadastrada ou o Entrevistado não respondeu nenhuma Pergunta!!!!!!!");
        }
    }
}