...
public class IBGE
{
    public static void main(String[] args) 
    {
        boolean confirmacaoErrada = true;
            ...
            Utilitarios.criarDiretorio("usuarios");// cria pasta usuarios senão existir
            Utilitarios.criarDiretorio("perguntas");// cria pasta perguntas senão existir
            Utilitarios.criarDiretorio("pessoasEntrevistadas");// cria pasta pessoasEntrevistadas senão existir
            Utilitarios.criarDiretorio("respostas");// cria pasta respostas senão existir
            do
            {
